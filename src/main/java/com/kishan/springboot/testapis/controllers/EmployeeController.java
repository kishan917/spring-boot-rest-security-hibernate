...
public class EmployeeController {
	...
	public String manageEmployee() {
		return "<p>\r\n"
				...
				+ "	</br>\r\n"
				+ "	<a href=\"/api/admin/employee\" > /api/admin/employee </a></br>\r\n"
				+ "		to fetch all employees</br>\r\n"
				+ "	</br>\r\n"
				+ "	<a href=\"/api/admin/employee/1\" > /api/admin/employee/{employeeId} </a></br>\r\n"
				+ "		to fetch specific employee using its ID e.g 1 2 3 </br>\r\n"
				+ "	</br>\r\n"
				+ "	<a href=\"/api/admin/employee/getEmployeeByName?employeeName=Employee_1\" > /api/admin/employee/getEmployeeByName?employeeName={employeeName} </a></br>\r\n"
				+ "		Yes...you guessed it right :)   Sample Employee names.. Employee_1, Employee_2, Employee_3</br>\r\n"
				+ "		</br>\r\n"
				+ "	<a href=\"/api/admin/employee/getEmployeeByDeptName?employeeDepartment=Department_1\" > /api/admin/employee/getEmployeeByDeptName?employeeDepartment={employeeDepartment} </a></br>\r\n"
				+ "		go for it....    Sample employeeDepartment .. Department_1, Department_2, Department_3</br></br>\r\n"
				+ "	</br>\r\n"
				+ "	<a href=\"/api/admin/addRandomEmployee\" > /api/admin/addRandomEmployee </a></br>\r\n"
				+ "		to add some employee</br>\r\n"
				+ "	</br>\r\n"
				+ "	<a href=\"/api/h2\" > Look into Database </a></br></br>\r\n"
				+ "	</br>\r\n"
				+ "	</br>\r\n"
				...
				+ "	</br>\r\n"
				+ "	</br>\r\n"
				+ "	<div style=\"align:center\"><a href=\"/api/logout\" > Logout </a></div></br>\r\n"
				+ "	</br>\r\n"
				+ "\r\n"
				+ "</p>";
	}
